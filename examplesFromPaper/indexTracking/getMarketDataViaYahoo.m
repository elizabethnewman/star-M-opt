function data = getMarketDataViaYahoo(symbol, startdate, enddate, interval)
    ...
    % CHANGES (Oct. 3, 2024): https://www.reddit.com/r/sheets/comments/1farvxr/broken_yahoo_finance_url/
    ...
    uri = matlab.net.URI(['https://query2.finance.yahoo.com/v8/finance/chart/', upper(symbol)],...
    'period1',  num2str(int64(startdate), '%.10g'),...
    'period2',  num2str(int64(enddate), '%.10g'),...
    'interval', interval,...
    'events',   'history',...
